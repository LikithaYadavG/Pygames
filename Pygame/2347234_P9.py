...
background_img = pygame.image.load("nature-colorful-landscape-dusk-cloud.jpg")
background_img = pygame.transform.scale(background_img, (screen_width, screen_height))
pygame.mixer.music.load("Jet_777_PassBy3.mp3")
pygame.mixer.music.play(-1)  # Play background music infinitely

# Load images
jet_img = pygame.image.load("air-force (1).png")
...
house_imgs = [pygame.image.load("house (1).png"), pygame.image.load("house (2).png"), pygame.image.load("mansion.png")]
house_imgs = [pygame.transform.scale(house, (70, 70)) for house in house_imgs]  # Resize houses

# Load sound effects
blast_sound = pygame.mixer.Sound("explosion-nearby-gamemaster-audio-1-00-01.mp3")
